...
export class AddSupportCountToAnalyticsMV1749695000000 implements MigrationInterface {
  private readonly viewName = 'report_analytics_mv';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Mevcut materialized view'ı sil
    await queryRunner.query(`DROP MATERIALIZED VIEW IF EXISTS ${this.viewName};`); // Yeni view'ı support_count dahil ederek yeniden oluştur
    ...
    `); // View üzerinde indexleri yeniden oluştur
    await queryRunner.query(
