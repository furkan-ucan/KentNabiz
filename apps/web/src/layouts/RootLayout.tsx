...
export const RootLayout: React.FC<RootLayoutProps> = ({ children }) => {
  ...
  const handleSnackbarClose = () => {
    ...
    <Menu
      ...
      PaperProps={{
        sx: {
          ...
          borderRadius: 2,
          boxShadow: `4px 4px 12px ${alpha('#000', 0.7)}`, // Mat + Modern gölge
          '& .MuiMenuItem-root': {
            borderRadius: 1,
            mx: 0.5,
            my: 0.25,
            ...
            '&:hover': {
              ...
              transform: 'translateX(4px)', // Mikro-animasyon
            },
          },
        },
      }}
    >
      ...
      <Divider sx={{ my: 1, borderColor: alpha(theme.palette.text.primary, 0.1) }} />
